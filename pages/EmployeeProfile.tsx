...
const EmployeeProfile: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className={`border rounded p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 ${dc ? 'bg-dark-surface border-dark-border' : 'bg-white border-atlassian-border'}`}>
